    ...
    <Grid container spacing={3}>
      <FormProvider methods={methods} onSubmit={handleSubmit(sendForm)}>
        <Grid container spacing={3}>
          ...
          <Grid
            xs={12}
            md={isTaxInfoEnabled ? 6 : 12}
            lg={isTaxInfoEnabled ? 6 : 12}
              ...
              <Grid container spacing={2}>
                ...
                <Grid xs={12} md={6} lg={6}>
                  <RHFSelect name="type" label="Tipo de Cliente" disabled={isSubmitting}>
                    <MenuItem value={TypeSchema.enum.INDIVIDUAL}>Persona Física</MenuItem>

                    <MenuItem value={TypeSchema.enum.BUSINESS}>Persona Moral (Empresa)</MenuItem>
                  </RHFSelect>
                </Grid>

                <Grid xs={12} md={6} lg={6}>
                  <BirthtdatePicker control={control} onSubmitting={isSubmitting} />
                </Grid>
              ...
              <Grid xs={12} md={6} lg={6}>
                <Card sx={{ p: 3 }}>
                  <Stack flexDirection="row" justifyContent="space-between" alignItems="center">
                    <Typography variant="h6">Datos de Facturación (México)</Typography>

                    <Button
                      onClick={handleResetTaxInfoData}
                      variant="soft"
                      disabled={isSubmitting || !isTaxInfoEnabled}
                    >
                      Limpiar Sección
                    </Button>
                  </Stack>
          ...
          <Grid xs={12} md={12} lg={12}>
            <Card sx={{ p: 3 }}>
              <Typography variant="h6">Formulario de Diagnóstico</Typography>

              <Divider sx={{ my: 2 }} />

              <Grid container spacing={2}>
                <Grid xs={8} md={4} lg={6}>
                  <DatePicker control={control} onSubmitting={isSubmitting} />
                </Grid>

                <Grid xs={4} md={2} lg={6}>
                  <RHFTextField name="di" label="DI" disabled={isSubmitting} placeholder="" />
                </Grid>
...
*/}
                ...
                {/* Sección Ojo Derecho */}
                <Grid xs={12}>
                  <Typography variant="subtitle1">Ojo Derecho (OD)</Typography>
                </Grid>
                ...
                <Grid xs={12}>
                  <Typography variant="subtitle1">Ojo Izquierdo (OI)</Typography>
                </Grid>
      ...
      <Grid xs={12} md={12} lg={12}>
        <Card sx={{ px: 3, pt: 3 }}>
          <Typography variant="h6">Notas de Venta a Crédito de {client.displayName}</Typography>
      ...
      <Grid xs={12} md={12} lg={12}>
        <Card sx={{ px: 3, pt: 3 }}>
          <Typography variant="h6">Historial de Depósitos Realizados</Typography>
