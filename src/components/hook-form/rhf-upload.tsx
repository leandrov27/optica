...
export function RHFUploadAvatar({ name, onReset, isSubmitting = false, ...other }: Props) {
  ...
  return (
    <Controller
      ...
      render={({ field, fieldState: { error } }) => (
        <div>
          <UploadAvatar error={!!error} file={field.value} {...other} onReset={onReset} isSubmitting={isSubmitting} />
